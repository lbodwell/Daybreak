...
void ADaybreakCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ADaybreakCharacter::OnResetVR);
}


void ADaybreakCharacter::OnResetVR()
{
	// If Daybreak is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Daybreak.Build.cs is not automatically propagated
