...
ADaybreakSword::ADaybreakSword() {
	...
	Levels.Emplace(4, "Emblazened Darkonium Sword", FLinearColor(0.6, 0.2, 1, 1), 0.75, 0.8, 0.75, 2000);
	Levels.Emplace(5, "The Sword of Darkosius", FLinearColor(1, 0.2, 0.1, 1), 1, 1, 1, 2400);
