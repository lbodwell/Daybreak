...
ADaybreakSword::ADaybreakSword() {
	...
	Levels.Emplace(3, "Darkinium Sword", FLinearColor(0.25, 0.03, 1, 1), 0.6, 0.4, 0.5, 1400);
	Levels.Emplace(4, "Emblazened Darkinium Sword", FLinearColor(0.6, 0.2, 1, 1), 0.75, 0.8, 0.75, 2000);
